...
Afin de réaliser ces opération de relocation de façon concurrente, ZGC maintient des tables de routage. Celles-ci sont stockées *off-heap* et optimisées pour une lecture rapide, au détriment d'un surcoût mémoire.
...
La répartition des objets par génération - stratégie nullement spécifuque à ZGC - est un axe majeur d'amélioration de ses performances.
