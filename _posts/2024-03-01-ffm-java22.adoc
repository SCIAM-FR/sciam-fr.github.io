...
NOTE: Bien que l'outil fasse partie du projet https://openjdk.org/projects/code-tools/[CodeTools] d'OpenJDK, il ne fait pas partie du JDK en tant que tel et n'est donc pas disponible de base dans les distributions du JDK.
