# -*- encoding: utf-8 -*-
# stub: asciidoctor-diagram 2.3.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/asciidoctor/asciidoctor-diagram/issues", "changelog_uri" => "https://github.com/asciidoctor/asciidoctor-diagram/blob/main/CHANGELOG.adoc", "documentation_uri" => "https://docs.asciidoctor.org/diagram-extension/latest/", "homepage_uri" => "https://github.com/asciidoctor/asciidoctor-diagram", "source_code_uri" => "https://github.com/asciidoctor/asciidoctor-diagram.git" } if s.respond_to? :metadata=
