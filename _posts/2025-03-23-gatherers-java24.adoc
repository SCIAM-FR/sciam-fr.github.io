...
On pourra l'utiliser de manière analogue à `isRejecting()`.
...
Dans l'autre cas, le stream utilisera `Spliterator::tryAdvance` car l'on ne sait pas si et quand le parcours se termine.
