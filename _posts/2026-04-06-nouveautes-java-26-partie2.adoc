...
image:/images/2026/nouveautes-java-26-partie2/article_java_26_partie_2_001.png[image,width=605,height=171]

Il est possible de sélectionner le thème sombre (dark).

image:/images/2026/nouveautes-java-26-partie2/article_java_26_partie_2_002.png[image,width=605,height=187]
...
=== La vérification plus stricte de la version par `jlink` lors du cross linking (https://bugs.openjdk.org/browse/JDK-8347831[JDK-8347831])
...
Toutes les évolutions proposées dans le JDK 26 sont recensées dans les https://www.oracle.com/java/technologies/javase/26u-relnotes.html[releases notes].
