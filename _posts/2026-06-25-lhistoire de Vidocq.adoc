...
C'est à l'excellente unconférence https://www.jchateau.org[JChateau] qu'a débuté l'aventure Vidocq.
...
Contrairement à la plupart des frameworks qui posent leurs propres règles (genre Spring), ces specs définissent des contrats précis, vérifiables, et sont chacune assorties d'un harnais de tests d'acceptance redoutable : le TCK (Technology Compatibility Kit).
...
Dans les faits, si Antoine s'est mis à la tâche le soir même et a obtenu un début de résultat au bout de quelques jours (60% du TCK passé), c'est Yann qui a industrialisé la tâche et l'a menée au bout. Cette étape a transformé une expérimentation en bootstrap de vrai projet.
...
Vidocq est à présent mis à disposition de la communauté avec une triple licence EUPL 1.2, EPL 2 et GPL 3.0. Il est possible de l'utiliser pour des projets personnels ou professionnels, de l'étudier, de le modifier et de le redistribuer.
