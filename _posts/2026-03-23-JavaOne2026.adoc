...
:page-excerpt: Retour sur JavaOne 2026 à Redwood Shores : Java prend officiellement le virage de l'IA, LangChain4j-CDI s'impose dans l'écosystème enterprise, et SCIAM était au cœur de l'événement avec un Hack Lab dédié.
:layout: post
:author: yannblazart
