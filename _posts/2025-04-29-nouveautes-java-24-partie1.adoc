...
Ce premier article est consacré aux nouveautés de Java 24 et détaille les fonctionnalités proposées via des JEPs dans la syntaxe et les API notamment issues des projets https://openjdk.org/projects/amber/[Amber], https://openjdk.org/projects/jigsaw/[Jigsaw], https://openjdk.org/projects/loom/[Loom] et https://openjdk.org/projects/panama/[Panama] d’OpenJDK et pour le première fois deux de ces nouvelles fonctionnalités sont issues des projets https://openjdk.org/projects/leyden/[Leyden] et https://openjdk.org/projects/lilliput/[Lilliput].
