...
Chez SCIAM, nous prenons ce tournant au sérieux — pas comme une tendance à suivre, mais comme une transformation profonde de la façon dont nous construisons les Systèmes d'Information.
