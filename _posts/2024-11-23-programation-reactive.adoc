...
Les principes de la programmation réactive sont décrits dans le "Manifeste Réactif"(accessible en ligne à l’adresse suivante : https://www.reactivemanifesto.org/), qui énonce quatre caractéristiques clés{nbsp}:
