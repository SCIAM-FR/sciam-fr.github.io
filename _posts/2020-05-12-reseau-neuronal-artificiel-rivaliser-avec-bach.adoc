...
image::{{'/images/reseau-neuronal-artificiel-rivaliser-avec-bach-002.png' | relative_url }}[image,width=604,height=453]
...
image::{{'/images/reseau-neuronal-artificiel-rivaliser-avec-bach-003.png' | relative_url }}[image,width=604,height=161]
...
.Auto-encodeur
image::{{'/images/reseau-neuronal-artificiel-rivaliser-avec-bach-004.png' | relative_url }}[image,width=256,height=232]
...
image::{{'/images/reseau-neuronal-artificiel-rivaliser-avec-bach-005.png' | relative_url }}[image,width=540,height=378]
...
image::{{'/images/reseau-neuronal-artificiel-rivaliser-avec-bach-006.png' | relative_url }}[image,width=524,height=933]
...
image::{{'/images/reseau-neuronal-artificiel-rivaliser-avec-bach-007.png' | relative_url }}[image,width=604,height=164]
...
image::{{'/images/reseau-neuronal-artificiel-rivaliser-avec-bach-008.png' | relative_url }}[image,width=604,height=340]
...
image::{{'/images/reseau-neuronal-artificiel-rivaliser-avec-bach-009.png' | relative_url }}[image,width=604,height=453]
...
image::{{'/images/reseau-neuronal-artificiel-rivaliser-avec-bach-010.png' | relative_url }}[image,width=100%]
...
image::{{'/images/reseau-neuronal-artificiel-rivaliser-avec-bach-011.png' | relative_url }}[image,width=604,height=340]

Voici les deux fonctions objectif qu’il faut optimiser, à savoir celle du discriminateur et celle du générateur :

image::{{'/images/reseau-neuronal-artificiel-rivaliser-avec-bach-012.png' | relative_url }}[image,width=604,height=145]
...
image::{{'/images/reseau-neuronal-artificiel-rivaliser-avec-bach-013.png' | relative_url }}[image,width=604,height=453]
...
image::{{'/images/reseau-neuronal-artificiel-rivaliser-avec-bach-014.png' | relative_url }}[image,width=100%]
...
image::{{'/images/reseau-neuronal-artificiel-rivaliser-avec-bach-015.jpeg' | relative_url }}[image,width=604,height=340]
