...
Par exemple, si l'on souhaite lire octet par octet le contenu de la chaîne de caractère en mémoire, on pourra utiliser le layout `ValueLayout.JAVA_BYTE`, qui correspond à la structure suivante :
