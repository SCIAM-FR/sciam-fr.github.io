...
_Cet article a été rédigé à partir de mes notes et retours personnels et premiers jets de JavaOne 2026, avec l'aide de Claude (Anthropic) pour la structuration et la mise en forme du texte. Il a été revu et retravaillé plusieurs fois jusqu'à obtenir ce résultat._
